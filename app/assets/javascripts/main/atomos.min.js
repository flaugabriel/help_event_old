...
(function (t) {
  ...
  t(document).on("mouseup", function () {
    ...
    drag: function (e, i, s) {
      ...
      for (d = s.snapElements.length - 1; d >= 0; d--) l = s.snapElements[d].left - s.margins.left, h = l + s.snapElements[d].width, c = s.snapElements[d].top - s.margins.top, u = c + s.snapElements[d].height, l - m > _ || g > h + m || c - m > b || v > u + m || !t.contains(s.snapElements[d].item.ownerDocument, s.snapElements[d].item) ? (s.snapElements[d].snapping && s.options.snap.release && s.options.snap.release.call(s.element, e, t.extend(s._uiHash(), {
      ...
      })), s.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (n = m >= Math.abs(c - b), o = m >= Math.abs(u - v), a = m >= Math.abs(l - _), r = m >= Math.abs(h - g), n && (i.position.top = s._convertPositionTo("relative", {
        ...
        top: 0,
        left: h
      }).left)), p = n || o || a || r, "outer" !== f.snapMode && (n = m >= Math.abs(c - v), o = m >= Math.abs(u - b), a = m >= Math.abs(l - g), r = m >= Math.abs(h - _), n && (i.position.top = s._convertPositionTo("relative", {
        top: c,
        left: 0
      }).top), o && (i.position.top = s._convertPositionTo("relative", {
  ...
  t.extend(s.prototype, {
    ...
    _generateHTML: function (t) {
      var e, i, s, n, o, a, r, l, h, c, u, d, p, f, m, g, _, v, b, y, w, k, x, C, D, T, I, M, P, S, N, H, A, z, O, E, W, F, L, R = new Date,
...
! function (t) {
  ...
  var a = t("body"),
    s = window.innerWidth;
  window.colors = ["#687ae8", "#12bfbb", "#ffb058", "#2991cf", "#87b8d4", "#109693", "#f29494", "#527cf9", "#7140d1", "#e79e4e", "#52b4ee", "#6ed7e0", "#8fa6b4", "#ffcfcf", "#28304e", "#95aac9", "#f2545b", "#f7bc06", "#00cc99", "#19b5fe", "#E3EBF6"], t('[data-toggle="tooltip"]').tooltip(), t(document).on("mouseenter", "body:not(.sidebar-pinned) .admin-sidebar", function (e) {
    ...
    e.preventDefault(), a.toggleClass("sidebar-pinned"), t(this).toggleClass("pinned"), window.dispatchEvent(new Event("resize"))
    ...
    e.preventDefault(), t(this).next().is(":visible") ? (t(this).next().slideUp(), t(this).parent().removeClass("opened")) : (t(this).next().slideDown(), t(this).parent().addClass("opened"))
  ...
  }), t(".js-scrollbar, .card-scroll").scrollbar(), t(".js-datepicker").datepicker(), t(".input-daterange").daterangepicker(), t(".js-select2").select2(), t(document).on("input", ".floating-label input", function (e) {
    ...
    valueNames: ["name"]
  }), new List("event-search", {
    valueNames: ["searchBy-name"]
  });
  var e = (new Date).getHours(),
    n = t(".js-greeting");
  e < 12 ? n.text("Good Morning") : e < 18 ? n.text("Good Afternoon") : n.text("Good Evening"), t(document).on("click", ".js-card-refresh", function (e) {
    var a;
...
function (s) {
  s.fn.alertNotify = function (e) {
    var a = s.extend({
      ...
      t = '<button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">&times;</span> </button> ';
    0 === this.find(".alert-container").length && this.append("<div class='alert-container'></div>"), a.dismiss || (t = ""), this.find(".alert-container").append('<div class="alert alert-' + a.type + ' alert-dismissible fade show" role="alert">' + a.message + t + "</div>")
  }
}(jQuery);